...
func (r *mysqlDatabaseResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	createResp, err := r.providerData.client.CreateDatabaseMysqlWithResponse(ctx, api.CreateDatabaseMysqlJSONRequestBody{
		...
		LimitsCpuShares:         tfInt64ToOptionalInt(plan.LimitsCpuShares),
		...
		LimitsMemorySwappiness:  tfInt64ToOptionalInt(plan.LimitsMemorySwappiness),
		MysqlConf:               base64EncodeAttr(plan.MysqlConf),
		MysqlDatabase:           plan.MysqlDatabase.ValueStringPointer(),
		MysqlPassword:           tfStringToOptionalString(plan.MysqlPassword),
		MysqlRootPassword:       tfStringToOptionalString(plan.MysqlRootPassword),
		MysqlUser:               plan.MysqlUser.ValueStringPointer(),
		ProjectUuid:             plan.ProjectUuid.ValueString(),
		PublicPort:              tfInt64ToOptionalInt(plan.PublicPort),
...
func (r *mysqlDatabaseResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	...
	uuid := tfStringToRequiredString(plan.Uuid)
